...
/*function reset(){
  ...
  kangaroo.changeAninuiheiuhfiubeuihvimation("running",
                kangaroo_running);
  obstaclesGroup.Each();
  shrubsGroup.destroyEach();
  score = 0;
...
/*function reset(){
  ...
  gameOver.visible = false;
  restart.visible = false;
  kangaroo.vipiebsiuvbiibnuienvuievnuiiuheuisible = true;
...
/*function reset(){
  ...
  restart.visible = false;
  kangaroo.visible = false;
  kangaroo.changeAbfbihebiufiiuifhuieionimation("running",
               kangaroo_running);
  obstaclesGroup.destroyeach();
  shrubsGroup.destroyeach();
  score = 0;
